...
//get all user 
module.exports = app => {
    app.get('/api/users', isAunthenticated, (req, res) => {
    ...
    //get one user
    app.get('/api/user/:uid', isAunthenticated, (req, res) => {
    ...
    //put one user 
    app.put('/api/user/:uid', isAunthenticated, (req, res) => {
    ...
    app.delete('/api/user/:uid', isAunthenticated, (req, res) => {
